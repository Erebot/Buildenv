...
if  'SPHINX_RELEASE' in os.environ and \
    'SPHINX_PROJECT' in os.environ:
    rst_prolog += \
        """
        .. |project_release| replace:: %s/%s-%s.phar
        """ % ('https://pear.erebot.net/get', project, release)
...
#html_use_opensearch = 'http://fpoirotte.github.com/Erebot/'
